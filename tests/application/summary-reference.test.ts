...
describe("summary references", () => {
  ...
  it("copies the current version reference without copying summary content", async () => {
    ...
    document.finalize(new SummaryVersion({ id: "version", documentId: "doc", sequence: 0, kind: "final", generationMode: "new", baseVersionId: null, content: { title: "Decision", abstract: "private abstract", bodyMarkdown: "private body", tags: [] }, sourceRevision: new SourceRevision("session", ["turn"], "hash"), model: null, createdAt: "b" }), false);
