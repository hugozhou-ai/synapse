...
const failures = [];
const domainForbidden = ["electron", "node:", "node:sqlite", "child_process", "osascript", "AppleScript"];
...
const rendererForbidden = ["@domain/", "node:sqlite", "child_process", "node:fs", "node:net", "osascript"];
