export type LogPrefix = "[synapse:hook]" | "[synapse:app-server]" | "[synapse:notes]" | "[synapse:publication]" | "[synapse:sqlite]" | "[synapse:ipc]" | "[synapse:main]" | "[synapse:renderer]" | "[synapse:plugin]";
